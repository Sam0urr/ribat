...
a:focus-visible,nav a:focus-visible,.toc a:focus-visible,.cta:focus-visible{
...
/* The bar's gradient-plus-blur is decoration; readers who have asked for
   less transparency or more contrast get a flat, opaque bar instead. */
...
@media (prefers-contrast:more){
  ...
  nav{border-bottom-color:var(--bone-2)}
}
...
nav a:not(.mark):active{color:var(--bone);transform:scale(.97);transition:transform 100ms ease-out}
...
.cta:active{transform:translateX(5px) scale(.97);transition:transform 100ms ease-out}
